// Demo data generator for AgentLend hackathon showcase
import type { ScoreInput } from '../types/index.js';
...
export async function generateDemoScores(): Promise<any[]> {
  const scores = [];

  for (const agent of DEMO_AGENTS) {
    const input: ScoreInput = {
      agentDID: agent.agentDID as any,
