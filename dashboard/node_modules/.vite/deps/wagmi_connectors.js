...
import {
  ...
  injected,
  mock
} from "./chunk-UYFTN4UL.js";
import "./chunk-BW4VZYTZ.js";
import "./chunk-FIZPPLJL.js";
import "./chunk-7TJEI6PY.js";
import "./chunk-ULVBP6ZP.js";
import "./chunk-ZNBQEBPS.js";
import {
  arbitrum,
  arbitrumSepolia,
  base,
  ...
  polygonAmoy,
  sepolia
} from "./chunk-5O7DBB25.js";
import "./chunk-RKZ23VFJ.js";
import {
  withRetry,
  withTimeout
} from "./chunk-A33IFRYR.js";
import "./chunk-SERL6H2L.js";
import {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-YWSHKFMF.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-BVNLXRUS.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-F3LJ7G5T.js");
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-O4ZE2VTB.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-RU277HP7.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-KEBOBWPU.js");
