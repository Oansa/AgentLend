...
var ICONS = {
  add: async () => (await import("./add-D3SBKAYM.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-7WVF35RY.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-MYPOJCCE.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-GRWCMP6H.js")).appStoreSvg,
  apple: async () => (await import("./apple-42XA56OT.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-AC6JOVOF.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-WG7VIJR3.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-NNHOX5B5.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-E3LBMDZO.js")).arrowTopSvg,
  bank: async () => (await import("./bank-WSSLICYC.js")).bankSvg,
  browser: async () => (await import("./browser-LQFGU3IU.js")).browserSvg,
  card: async () => (await import("./card-2EGZQGYJ.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-IFPOBIKR.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-PWC7DLNA.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-QNUOQFZ2.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-KJB4AYMZ.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-KC4RGQ3U.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-AT24JO7A.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-7HNAJPYU.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-26DC6OQQ.js")).clockSvg,
  close: async () => (await import("./close-JLCEHSWZ.js")).closeSvg,
  compass: async () => (await import("./compass-UCWXGUSP.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-SRYKT5CU.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-XVPVASCP.js")).copySvg,
  cursor: async () => (await import("./cursor-DXHR424P.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-5TAFO4I5.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-DAGCE7BW.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-7B5NFBFT.js")).disconnectSvg,
  discord: async () => (await import("./discord-HZW6QVPK.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-GPSHZLFZ.js")).etherscanSvg,
  extension: async () => (await import("./extension-74Y4WFR3.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-NEJVZI62.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-GO7YE53K.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-E3UCPPIG.js")).farcasterSvg,
  filters: async () => (await import("./filters-MGXJBI3N.js")).filtersSvg,
  github: async () => (await import("./github-ST5F5EBS.js")).githubSvg,
  google: async () => (await import("./google-25EUT3JD.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-J4CYC7Q2.js")).helpCircleSvg,
  image: async () => (await import("./image-RCEXNYRA.js")).imageSvg,
  id: async () => (await import("./id-BGQHLDC3.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-VR25WGN7.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-RGYROS6K.js")).lightbulbSvg,
  mail: async () => (await import("./mail-CH34ADTY.js")).mailSvg,
  mobile: async () => (await import("./mobile-RUKXYSM5.js")).mobileSvg,
  more: async () => (await import("./more-HRIW2P2A.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-3OVCGZB4.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-ZX3SWWHJ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-KXA3AXQA.js")).offSvg,
  playStore: async () => (await import("./play-store-3UAKESW3.js")).playStoreSvg,
  plus: async () => (await import("./plus-UBY3R6NG.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-KPCYSLKN.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-7QMAP3WJ.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-WPFJUWQR.js")).refreshSvg,
  search: async () => (await import("./search-QCBZ4T4W.js")).searchSvg,
  send: async () => (await import("./send-YTM7KZSP.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-DNNIVYVK.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-UW7LSDAT.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-Q4PTVN75.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-VLBKXLU4.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-I3UFTLV6.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-QPLIBGON.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-HF6XI45Z.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-2S2VCWHP.js")).twitchSvg,
  twitter: async () => (await import("./x-QOXQOYNL.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-VSTTT2ID.js")).twitterIconSvg,
  verify: async () => (await import("./verify-5WZKSF23.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-FSNXLGDM.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-H77QZ4BZ.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-BIEADYHO.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-BIEADYHO.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-BIEADYHO.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-UEVNLVMS.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-YZAEQ47Z.js")).warningCircleSvg,
  x: async () => (await import("./x-QOXQOYNL.js")).xSvg,
  info: async () => (await import("./info-2RFEBPZL.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-64CGCS6B.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-QWVUERXL.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UMELYFJL.js.map
