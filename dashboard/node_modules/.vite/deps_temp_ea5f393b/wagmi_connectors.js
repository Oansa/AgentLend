...
import {
  ...
  call_exports,
  mini_exports
} from "./chunk-Z43FJHGC.js";
import "./chunk-Z65AVHCV.js";
...
import {
  ...
  injected,
  mock
} from "./chunk-I7EU2U4Q.js";
import "./chunk-BW4VZYTZ.js";
import "./chunk-GTPRTJKW.js";
import {
  arbitrum,
  arbitrumSepolia,
  base,
  ...
  polygonAmoy,
  sepolia
} from "./chunk-VKIKWD4T.js";
import "./chunk-KQWHSQCB.js";
import "./chunk-TZTD24CY.js";
import {
  withRetry,
  withTimeout
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-AISOCSKJ.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-OQKJUFJ3.js");
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-4R2C4TCV.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-XSQ2DSZE.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-YQ7CO3XG.js");
