...
const envSchema = zod_1.z.object({
    ...
    CAP_API_URL: zod_1.z.string().url().optional(),
    CAP_WS_URL: zod_1.z.string().url().optional(),
    CAP_API_KEY: zod_1.z.string().optional(),
    CROO_API_KEY: zod_1.z.string().optional(),
    CROO_AGENT_DID: zod_1.z.string().optional(),
    CROO_API_URL: zod_1.z.string().url().optional(),
    CROO_WS_URL: zod_1.z.string().url().optional(),
    // Rate Limiting
